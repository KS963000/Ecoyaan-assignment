...
//           <div className="text-3xl font-semibold pl-3">Our Values</div>
...
//               />
//               <div>
//                 <div className="font-semibold text-xl">Trust</div>
//                 <p className="text-lg">
...
//               </div>
//             </div>
//             <div className="value-item flex ml-4">
//               <img
//                 src="https://ecoyaan.com/images/Authenticity.png"
//                 className="h-[100px] img-fit img-fit-height img-hover"
//                 alt="Authenticity"
//               />
//               <div>
//                 <div className="font-semibold text-xl">Authenticity</div>
//                 <p className="text-lg">
//                   We are genuine in our mission to promote sustainability and
...
//               </div>
//             </div>
//             <div className="value-item flex mt-4">
//               <img
//                 src="https://ecoyaan.com/images/Impact.png"
//                 className="h-[100px] img-fit img-fit-height img-hover"
//                 alt="Impact"
...
//               </div>
//             </div>
//             <div className="value-item flex mt-4 ml-4">
//               <img
//                 src="https://ecoyaan.com/images/FunAndEngaging.png"
//                 className="h-[100px] img-fit img-fit-height img-hover"
//                 alt="FunAndEngaging"
//               />
//               <div>
//                 <h3 className="font-semibold text-xl">Fun & Engaging</h3>
//                 <p className="text-lg">
//                   Moving towards a sustainable lifestyle and the constant news
